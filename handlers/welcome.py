...
async def welcome(client, message):
    await Flaming.clear_welcome(str(message.chat.id))
...
async def new_welcome(app: Client, message):
    msg_id = await Flaming.get_welcome(str(message.chat.id))
    caption = ""
    men = ""
...
async def setwelcome(app: Client, message):
    ...
    await Flaming.save_welcome(str(message.chat.id), msg_id)
