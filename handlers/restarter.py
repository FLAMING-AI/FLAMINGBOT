...
async def restart_get(client: Client, message: Message):
    try:
        flaming = await message.reply_text("**Restarting userbot...**")
        await restart(message, restart_type="restart")
    except:
        await flaming.edit_text("**An error occured...**")
...
async def update(client: Client, message: Message):
    try:
        ...
        link = "https://github.com/FLAMING-AI/FLAMINGBOT/archive/refs/heads/main.zip"
